...
- git в этой папке не инициализирован
...
Следующая реальная инженерная задача - превратить эту папку в git-репозиторий и создать Laravel-каркас, чтобы уже работать от документации к коду.
