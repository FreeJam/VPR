...
- базовый MVP уже реализован: auth, роли, импорт, назначения, попытки, review
...
2. Добрать teacher-group UI и назначение по группам.
3. Реализовать student history/results screens отдельным экраном.
4. Добрать parent UI, аналитику и admin CRUD.
